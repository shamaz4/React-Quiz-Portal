...
export default function Routing() {
  ...
  return (
    <div>
      <Routes>
        <Route exact path="/"
          element={<TeacherAuthPage getTeacherId={getTeacherId} getTeacherPassword={getTeacherPassword} teacherId={teacherId} teacherPassword={teacherPassword} />} />


        <Route path="/studentLogin"
          element={<StudentAuthPage filteredData={filteredData} loginStudent={loginStudent} getStudentId={getStudentId} getStudentPassword={getStudentPassword} />}
        />
        ...
        <Route path="/addStudent"
          element={<AddStudent getStdBasicInfo={getStdBasicInfo} />}
        />

        <Route path="/addMarks"
          element={<StudentMarks getStdMarks={getStdMarks} sumUpData={sumUpData} />}
        />

        <Route path="/quizQuestion"
          element={<TeacherQuizQuestions handleQuestion={handleQuestion} saveData={saveData} />}
        />
